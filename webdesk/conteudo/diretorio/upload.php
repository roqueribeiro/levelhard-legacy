	...
	{//Envia Arquivo
		...
		if(isset($_FILES['arquivo']))
		{
			...
			{			
				...
				{
					resize_imagem($_FILES['arquivo']['tmp_name'][$key],120,120,$pasta.$_FILES['arquivo']['name'][$key]."_min");
					resize_imagem($_FILES['arquivo']['tmp_name'][$key],2560,1600,$pasta.$_FILES['arquivo']['name'][$key]);
				}
				else
				{
