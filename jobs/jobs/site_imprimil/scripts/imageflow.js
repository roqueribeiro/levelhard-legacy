...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		onClick:            function() { $.fancybox.open({ href:this.url, title:this.getAttribute('alt'), padding:5, margin:50, helpers:{ title	: { type : 'over' }, overlay:{ opacity: 0.6, css:{ background:'#000' }}}}); },
		...
		reflectionPNG:      'reflect3.php', /* Toggle reflect2.php or reflect3.php */
	...
	this.loadingStatus = function()
	{
		...
		var loadingTxt = document.createTextNode('Carregando Imagens '+completed+'/'+i);
