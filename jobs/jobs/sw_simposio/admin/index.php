<?php
	...
	else 
	{
		...
		$QueryLoginApply = mysqli_query($bd_connect, $QueryLogin);
		$QueryLoginResults = mysqli_num_rows($QueryLoginApply); 
		if ($QueryLoginResults > 0)
		{
			while ($ResultLoginRow = mysqli_fetch_array($QueryLoginApply)) 
			{
