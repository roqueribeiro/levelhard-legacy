...
session_start();
	...
	default:
		...
		$(document).ready(function(){
			...
			{
				$('#navegadores').fadeIn(3000); 
			}
			else
			{
				$('#theme_con').corner('10px');
				$('#theme_con1').corner('10px');
			}
...
//			rightSpace:(0),
//			bottomSpace:(0),
//			overflow:('hidden'|'auto') // [NOTE: setting to auto makes maxImage less accurate... use at your own risk], <br>
...
function PagCon()
{
	...
	<img src="wall/'.$WALLPAPER.'" class="maximage" />
...
function PagLista()
{
	...
	{
		$contatos = '<tr><td colspan="10" align="center" bgcolor="#FFFFFF">Nenhum Contato Encontrado!</td></tr>';
	}
