<?php
	...
	$selected["AbstratoNuvens.jpg"] = 'selected=\"selected\"';
...
<title>WebRoCkY.com.br</title>

<link rel="stylesheet" media="screen" href="wrocky_theme/css/StyleAll.css" />
<link rel="stylesheet" media="screen" href="wrocky_theme/css/StyleSystem.css" />
<link rel="stylesheet" media="screen" href="wrocky_theme/css/StyleTemplate.css" />
<link rel="stylesheet" media="screen" href="wrocky_theme/css/StyleEffects.css" />
<link rel="stylesheet" media="screen" href="wrocky_theme/css/StyleMenu.css" />
<link rel="stylesheet" media="screen" href="scripts/fancybox/jquery.fancybox-1.3.4.css" />
<link rel="stylesheet" media="screen" href="wrocky_theme/css/jquery-ui-1.8.12.custom.css" />
<link rel="stylesheet" media="screen" href="wrocky_theme/css/AeroWindow.css" />
<link rel="stylesheet" media="screen" type="text/css" href="scripts/jcarousel/wrocky/skin.css" />
...
$(document).ready(function(){
	...
	$('#loading').fadeIn(600);
	$('#loadingbg').css('opacity','0.2');
	$('#loadingbg').fadeIn(300);
	...
	window.onload = function(){
		...
		$('#loadingbg').fadeOut(1000,function(){
			...
			$('#bg_repeat').change(function(){
				...
				$('#background').css('background-repeat',bg_size);
			});
			...
			$('#bg_position').change(function(){
				bg_size = $(this).attr('value');
				$('#background').css('background-position',bg_size);
			});
			...
			$('#wrocky_effect_icons img').mouseenter(function(){
				$('#wrocky_inform').html($(this).attr('alt')).stop().animate({'opacity':'1'});
			});
			$('#wrocky_effect_icons img').mouseleave(function(){
				$(this).html('');
				$('#wrocky_inform').stop().animate({'opacity':'0'});
			});
...
<div id="wrocky_back">
    ...
    <div id="wrocky_icons">
        ...
        <div id='wrocky_menu_reflect'>
        	...
        	<ul id="wrocky_effect_icons" class="jcarousel-skin-wrocky">
            	<li>
                <a id="fancy_frame" href="wrocky/webclin/apresentacao">
                <img src="icones/webclin.jpg" alt="WebClin 2 Mini Gerência de Consultas" />
                </a>
                </li>
            	<li>
                <a id="fancy_frame" href="http://www.votofix.com">
                <img src="icones/votofix.jpg" alt="VotoFix - Sistemas para Vereadores" />
                </a>
                </li>
            	<li>
            	...
            	<li>
                <a id="fancy_frame" href="http://www.gdata.com.br">
                <img src="icones/gdata.jpg" alt="Global Data Soluções de Internet" />
                </a>
                </li>
            	<li>
                <a id="fancy_frame_down" href="wrocky/estudo/">
                <img src="icones/download.jpg" alt="Downloads de Exemplos e Estudos" />
                </a>
                </li>
            </ul>
            </div>
    ...
    <div id="wrocky_foot">
        ...
        <a id="fancy_ajax" href="wrocky_act/wrocky_mail.php" title="roque.ribeiro@levelhard.com.br"><b>Entre em Contato! Clique Aqui.</b></a>
        </div>
    </div>
        
    <div id="wrocky_chat"></div>
