...
$(document).ready(function() {
	$('#ajax').load('content/principal.html');
	$('#container').hide();
	$('#loading').fadeIn(400);
...
<div id="container">
	<div id="header">
        ...
        <div id="menu">
       	...
       	<!--
            <ul>
                <a href="javascript:LinkLoad('content/contato.html');"><li>Gerontologia</li></a>
            </ul>
            <ul>
                <a href="javascript:LinkLoad('content/contato.html');"><li>Agenda</li></a>
            </ul>
            <ul>
                <a href="javascript:LinkLoad('content/contato.html');"><li>Filmes</li></a>
            </ul>
            <ul>
