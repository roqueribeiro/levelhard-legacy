		...
		$.post('core/core.php',{'tela':'principal'},function(data){
			...
			$('#menu li, #botao').click(function(){
				...
				if(destino)
				{
					if (destino == "loja")
					{
						window.location = "http://vipax.com.br/loja";
					}
...
<body>
	...
	<div id="container">
    	<div id="topo">
        	<div id="topo_cont">
                ...
                <ul>
                    ...
                    <a href="#" target="_blank">
                        <img src="image/icones/social-fca/facebook-icon.png" alt="">
                    </a>	
                    </li>
                    <li>
                    <a href="#" target="_blank">
                        <img src="image/icones/social-fca/twitter-icon.png" alt="">
                    </a>
                    </li>
                    <li>
                    <a href="#" target="_blank">
                        <img src="image/icones/social-fca/skype-icon.png" alt="">
                    </a>
                    </li>
                </ul>
                </div>
            ...
            <div id="rodape">
                Desenvolvido por <a href="http://www.levelhard.com" target="_blank">LevelHard 2012</a> & <a href="http://decisoesinteligentes.com.br" target="_blank">IPETEC</a>
            </div>
        </div>
    </div>
</body>
